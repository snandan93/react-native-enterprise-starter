...
import type { AuthStackParams, MainTabsParams, TaskStackParams } from './types';
import { useTranslation } from '@localization';
const Auth = createNativeStackNavigator<AuthStackParams>();
const Tasks = createNativeStackNavigator<TaskStackParams>();
...
export function AppNavigator() {
  ...
  return (
    <NavigationContainer theme={navTheme}>
      {status === 'authenticated' ? <MainNav /> : <AuthNav />}
    </NavigationContainer>
  );
}
